...
exports.getAllPatients = catchAsync(async (req, res, next) => {
  ...
  const patients = await query
    .select('_id firstName lastName phone patientCardNumber dateOfBirth paymentStatus createdAt lastVisit')
...
exports.getPatientsByDoctor = catchAsync(async (req, res, next) => {
  const patients = await Patient.find({ primaryDoctor: req.params.doctorId })
    .select('firstName lastName phone dateOfBirth lastVisit ')
    .sort('lastName');
