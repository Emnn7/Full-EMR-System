...
import { 
  ...
  InputLabel, Select, MenuItem, Checkbox, FormControlLabel, Divider, CircularProgress
} from '@mui/material';
import { createMedicalHistory, updateMedicalHistory, fetchMedicalHistoryById } from '../../redux/slices/medicalHistorySlice'
  ...
  return (
    <Paper sx={{ p: 3, maxWidth: 800, margin: 'auto' }}>
      <Typography variant="h5" gutterBottom>
        {isEditMode ? 'Update Medical History' : 'Initial Medical History Form'}
      </Typography>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            <Button 
              ...
              sx={{ mt: 2 }}
            >
              {isEditMode ? 'Update Medical History' : 'Submit Medical History'}
            </Button>
          </Grid>
        </Grid>
      </form>
